...
import ajPanwitImage from "../assets/images/cat.jpeg";
    ...
    <Layout>
      ...
      <section className="container mx-auto py-8">
        ...
        <p className="text-right mt-8">
          ...
          ซึ่งมีบริการ เครื่องดื่มและขนมหวานมากมาย และหนังสือที่หลากหลาย สามารถเข้ามาอ่านได้ฟรี และสามารถยืมไปอ่านที่บ้านได้ โดยไม่มีค่าใช้จ่าย ฟรี!!!!
        </p>
      </section>
